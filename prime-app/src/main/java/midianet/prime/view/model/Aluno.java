package midianet.prime.view.model;

import midianet.prime.Convertible;
import midianet.prime.util.DozerUtil;
import lombok.Data;
...
//ex            Thu Jun 23 2016 00:00:00 GMT-0300 (BRT)
                ...
                mapping(midianet.prime.entities.Aluno.class, Aluno.class,
...
//                mapping(Aluno.class, Aluno.class,
//                        TypeMappingOptions.oneWay(),
//                        mapId("A"),
//                        mapNull(true),
//                        TypeMappingOptions.dateFormat(dateFormat)
...
//                );
    ...
    public static Aluno from(final midianet.prime.entities.Aluno a) {
        return DozerUtil.getMapper().map(a, Aluno.class);
    }

    public midianet.prime.entities.Aluno toEntity() {
        return DozerUtil.getMapper().map(this, midianet.prime.entities.Aluno.class);
    }
